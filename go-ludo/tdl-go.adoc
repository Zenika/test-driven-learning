...
Je comprends les variables sont déclarées sous la forme :
...
Pour créer cette méthode je doit pouvoir passer un paramètre à une fonction et convertir un `int` et `string`.
