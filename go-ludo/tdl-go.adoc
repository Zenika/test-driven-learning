...
Après quelques lectures de la documentation et de quelques samples, je comprends que Go est principalement un langage fonctionnel où les fonctions sont simplement exposée par le package.
