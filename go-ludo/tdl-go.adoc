...
Go est un langage qui buzz beaucoup depuis quelques temps, j'ai donc eut l'envie de m'initier à ce langage.
...
Je faire sûrement un tour de Go : https://tour.golang.org/welcome/
